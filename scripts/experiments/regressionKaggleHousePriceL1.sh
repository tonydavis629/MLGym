...
run_experiment() {
    ...
    python run.py \
        ...
        --task_config_path tasks/regressionKaggleHousePriceL1.yaml \
        --model "$model" \
...
python scripts/process_results.py \
    ...
    --traj_pattern regressionKaggleHousePriceL1__better_thought_action_parser_with_insert__t-0.00__p-0.95__c-4.00__install-0__parallel_agents \
    --models "${MODELS[@]}" \
    --priority_metric "r2" \
    --metric_direction maximize > results/regressionKaggleHousePriceL1.res
