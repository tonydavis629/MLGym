...
python scripts/process_results.py \
    ...
    --traj_pattern rlMountainCarContinuousReinforce__better_thought_action_parser_with_insert__t-0.00__p-0.95__c-4.00__install-0__parallel_agents \
    --models "${MODELS[@]}" \
    --priority_metric "Reward Mean" \
    --metric_direction maximize > results/rlMountainCarContinuousReinforce.res
